...
class CasparCG extends events_1.EventEmitter {
    ...
    play(channel, layer = NaN, clip, loop, transition, transitionDurationOrMaskFileOrStingProps, transitionEasingOrStingDuration, transitionDirectionOrOverlay, seek, length, filter, channelLayout, clearOn404) {
        return this.do(new AMCP_1.AMCP.PlayCommand(Object.assign(Object.assign({ channel, layer, clip, loop, transition }, this._createTransitionOptionsObject(transition, transitionDurationOrMaskFileOrStingProps, transitionEasingOrStingDuration, transitionDirectionOrOverlay)), { seek, length, filter, channelLayout, clearOn404 })));
    }
    /**
    ...
    loadHtmlPageBg(channel, layer = NaN, clip, transition, transitionDurationOrMaskFile, transitionEasingOrStingDuration, transitionDirectionOrOverlay, auto) {
        return this.do(new AMCP_1.AMCP.LoadHtmlPageBgCommand(Object.assign(Object.assign({ channel: channel, layer: layer, clip: clip, transition: transition }, this._createTransitionOptionsObject(transition, transitionDurationOrMaskFile, transitionEasingOrStingDuration, transitionDirectionOrOverlay)), { auto: auto })));
    }
    /**
     *
     */
    loadHtmlPageBgAuto(channel, layer = NaN, url, transition, transitionDurationOrMaskFile, transitionEasingOrStingDuration, transitionDirectionOrOverlay) {
        return this.do(new AMCP_1.AMCP.LoadHtmlPageBgCommand(Object.assign(Object.assign({ channel: channel, layer: layer, url: url, transition: transition }, this._createTransitionOptionsObject(transition, transitionDurationOrMaskFile, transitionEasingOrStingDuration, transitionDirectionOrOverlay)), { auto: true })));
    }
    /**
     * <https://github.com/CasparCG/help/wiki/AMCP-Protocol#LOAD>
     */
    ...
    _createTransitionOptionsObject(transition, transitionDurationOrMaskFileOrProps, transitionEasingOrStingDuration, transitionDirectionOrOverlay) {
        if (transition === ServerStateEnum_1.Enum.Transition.STING.toString()) {
            if (typeof transitionDurationOrMaskFileOrProps === 'object') {
                return {
                    stingTransitionProperties: Object.assign({}, transitionDurationOrMaskFileOrProps)
                };
            }
            else {
                return {
